...
@app.post("/webhook/lovable", response_model=dict)
async def lovable_webhook(request: Request):
    ...
    try:
        ...
        # Extrair mensagem do usuário (múltiplos formatos)
        user_message = (
...
async def test_sql_agent():
    ...
    from models import AgentInstruction, AgentType, SQLQueryRequest
