...
class AgentType(str, Enum):
    ...
    PERIOD_COMPARISON = "period_comparison_agent"  # Comparação entre períodos
    CLIENT_VIEW = "client_view_agent"  # Visão cliente (por cliente_id)
    SALE_VIEW = "sale_view_agent"  # Visão venda (por id_venda)
    PRODUCT_VIEW = "product_view_agent"  # Visão produto (por produto)
    CLUSTER_VIEW = "cluster_view_agent"  # Visão cluster (comportamento por cluster)
    ERROR = "error"
...
class WebhookPayload(BaseModel):
    ...
    # Campo adicionado para compatibilidade com SessionManager
